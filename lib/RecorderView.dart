...
class _RecordPageViewState extends State<RecordPageView> {
        ...
        body: Column(
          ...
          children: [
            ...
            if (_amplitude != null) ...[
              ...
              Text('Current: ${(20 * log10(32768 * _amplitude!.current))}'),
  ...
  void _startTimer() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (Timer t) {
      ...
      if (_recordDuration % 60 == 0) {
        // all amplitudes
        debugPrint(
            "dBFS: ${_amplitude!.current}; dB: ${20 * log(32768 * _amplitude!.current)}");
        // fourier
        // uploadSoundData();
        // debugPrint("Upload: ${_amplitude?.current as String?}");
      }
    });
  }
}
